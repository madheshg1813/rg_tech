...
const WhyChooseUs = () => {
    return (
        <section id="about" className="on-dark py-24 surface-dark text-white relative overflow-hidden">
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#F59E0B]/5 rounded-full blur-[120px]"></div>
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="grid md:grid-cols-3 gap-12">
                    <div className="md:col-span-1">
                        <p className="text-accent font-bold text-sm uppercase tracking-widest mb-4">Why Choose Us</p>
                        <h3 className="text-3xl md:text-4xl font-bold font-heading leading-tight">Expertise That <br /><span className="text-accent">Drives Precision</span></h3>
                    </div>
                        ...
                        {differentiators.map((d, i) => {
                            ...
                            return (
                                <div key={i} className="flex gap-6 group">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center group-hover:bg-[#F59E0B] transition-colors duration-300">
