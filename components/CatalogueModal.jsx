    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in">
            <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
                <div className="sticky top-0 hero-gradient p-6 rounded-t-3xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#F59E0B] focus:ring-4 focus:ring-[#F59E0B]/10 outline-none transition-all"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid gap-3">
                                {catalogues.map((cat, idx) => (
                                    <div key={idx} className="border-2 border-gray-200 rounded-xl p-4 hover:border-[#F59E0B] transition-all group">
