...
export default function MildSteelPage({ city, works, articles }) {
    const copy = mildSteelCopy(city)
    const a = MILD_STEEL
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="relative hidden lg:block">
                            ...
                            <div className="framed absolute -bottom-5 -left-4 xl:-left-8 px-5 py-4 z-20">
                                <p className="meta-label text-fg-subtle mb-1">{a.heroBadge.label}</p>
                                <p className="subsection-title text-fg">
                                    {a.heroBadge.value}<span className="text-accent">{a.heroBadge.unit}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-14">
                        ...
                        <p className="section-lead mt-4 max-w-2xl mx-auto">
                            Thickness, edge quality and mill scale are what decide a
                            mild steel job. Here is what tends to go wrong, and what
                            we do about it.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-white border-t border-line">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-14">
                        ...
                        <h2 className="section-title text-fg">
                            Looking for something in mild steel?{' '}
            ...
            <section className="py-20 bg-surface-2 border-t border-line">
                <div className="max-w-5xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="section-title text-fg">
                            Mild steel cutting <span className="text-accent">questions</span>
                        </h2>
                    </div>
