...
import { GODS, GOD_GROUPS, getGod } from '@/lib/gods'
 ...
 *
 * Drives the /designs/gods index. Galleries with no images are left out for
 ...
 * being filled in.
 */
export function godDesignGroups() {
...
export function crosslinkDesigns(currentSlug, fallbackImage) {
    return CROSSLINK_GODS.map((key) => {
        ...
        return {
             ...
             */
            href: gallery ? godDesignUrl(gallery.slug) : '/designs/gods',
            image,
