import { BASE_URL, CHENNAI_LOCALITIES, pillarServices, GMB_URL, GMB_MAP_URL } from './data'
...
export const organizationSchema = {
    ...
    // Links the website to the Google Business Profile. This is the signal
    // Google uses to reconcile the two as one entity, so it matters for the
    // local pack far more than most on-page markup.
    "sameAs": [GMB_URL, GMB_MAP_URL],
    "hasMap": GMB_MAP_URL,
