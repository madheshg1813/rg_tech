import { BASE_URL, CHENNAI_LOCALITIES, pillarServices, GMB_URL, GMB_MAP_URL, JUSTDIAL_URL, SOCIAL_LINKS } from './data'
...
export const organizationSchema = {
    ...
    // Links the website to the Google Business Profile and the owned social
    // channels. This is the signal Google uses to reconcile them as one entity,
    // so it matters for the local pack far more than most on-page markup.
    // Every URL here must resolve — a dead sameAs is worse than a short list.
    "sameAs": [GMB_URL, GMB_MAP_URL, JUSTDIAL_URL, ...SOCIAL_LINKS.map((s) => s.url)],
    "hasMap": GMB_MAP_URL,
