...
export const MILD_STEEL = {
    ...
    subServices: [
        { name: 'Mild steel sheet laser cutting', desc: '0.8 - 6 mm CR and HR sheet, cut to your drawing.' },
        { name: 'Mild steel plate laser cutting', desc: '8 - 45 mm plate for structural and machine work.' },
        ...
        { name: 'Mild steel gate laser cutting', desc: 'Cut panels for main gates, wickets and railings.' },
        { name: 'Mild steel decorative laser cutting', desc: 'Jali screens, partitions and wall panels in MS.' },
        { name: 'MS laser cutting designs', desc: 'Pattern library or your own artwork, any scale.' },
