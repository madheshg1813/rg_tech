...
export const catalogues = [
    ...
    // All four catalogues are served locally. Cloudinary blocks PDF/ZIP delivery
    // by default (Settings -> Security -> Restricted media types), and the other
    // three volumes exceed the 10 MB free-tier upload limit. See CLOUDINARY.md.
