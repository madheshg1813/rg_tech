...
/*
 * The Justdial listing.
 *
 * This is the resolved canonical URL, not the jsdl.in short link it was shared
 * as, and the ?via=scode tracking parameter is dropped. Same reasoning as the
 * Google URLs above: a short link is an extra hop that can rot, and this one
 * ends up in schema.org sameAs where a dead URL is worse than a short list.
 */
export const JUSTDIAL_URL =
    'https://www.justdial.com/Chennai/Rg-Tech-Engineering-Works-Athipet/044PXX44-XX44-241225050517-L1L7_BZDET'
/*
 * Social channels.
 *
...
export const pillarServices = [
    {
        ...
        /*
         * Sub-services: the specific jobs people actually search for inside this
         * category. Rendered as a section on the PILLAR ONLY — 822 locality
         * pages repeating the same list would be duplicate content, and the
         * point of these is to earn the pillar its own long-tail terms.
         *
         * Each entry is a real line of work with a real description, not a
         * keyword in a box. They also feed the OfferCatalog in the page's
         * structured data, and are shaped so any of them can later become its
         * own page without the data changing.
         */
        subServices: [
            { name: 'Higher Thickness Laser Cutting', desc: 'Plate that most job shops turn away — up to 45 mm in mild steel, cut in a single pass.' },
            { name: 'Large Bed Size Laser Cutting', desc: 'An 8000 x 2500 mm bed takes a full sheet in one setup, so long parts carry no joint.' },
            { name: 'Customized Laser Cutting', desc: 'One-off parts cut from your drawing, sketch or a sample. No tooling and no minimum order.' },
            { name: 'Photo-Based Laser Cutting', desc: 'Send a photograph and we trace it into a cutting file — portraits, logos and temple images.' },
        ],
    ...
    },
    {
         ...
         */
        subServices: [
            { name: 'Thick Sheet Metal Laser Cutting', desc: 'Heavy gauge and plate to 45 mm, cut with oxygen or nitrogen to suit the finish you need.' },
            { name: 'Large Sheet Laser Cutting', desc: 'Full 8000 x 2500 mm sheets processed whole, so a long panel needs no join.' },
            { name: 'Industrial Sheet Metal Laser Cutting', desc: 'Production runs for OEMs and fabricators, nested for yield and repeatable batch to batch.' },
            { name: 'Transformer Safety Guard Laser Cutting', desc: 'Ventilated guards and enclosure panels for transformer and switchgear installations.' },
            { name: 'Support Pipe Laser Cutting', desc: 'Brackets, saddles and cut-outs for pipe supports and structural runs.' },
            { name: 'Rack Stand Laser Cutting', desc: 'Flat components for storage racks, display stands and equipment frames.' },
            { name: 'AC Cabinet Laser Cutting', desc: 'Louvre, vent and access panels for air-conditioning and control cabinets.' },
        ],
        /* Purpose-shot landing image for this category. Used on the pillar
         * AND every locality page, replacing the rotated gallery pool — one
         * deliberate photograph beats a stock shot that changes per city.
    ...
    },
    {
         ...
         */
        subServices: [
            { name: 'Laser Cutting & Fabrication', desc: 'Cutting, bending, welding and finishing under one roof, so parts leave ready to install.' },
            { name: 'Custom Laser Cut Fabrication', desc: 'Built to your drawing or ours, from a single prototype to a repeat production run.' },
            { name: 'Rack Stand Fabrication', desc: 'Storage racks, display stands and equipment frames, welded and coated.' },
            { name: 'Steel Laser Cut Furniture', desc: 'Tables, benches, planters and partitions in laser-cut steel.' },
            { name: 'Support Pipe Fabrication', desc: 'Pipe supports, saddles and structural runs cut, welded and delivered.' },
            { name: 'AC Cabinet Fabrication', desc: 'Outdoor unit housings, louvre covers and service cabinets built to size.' },
        ],
        /* Purpose-shot landing image for this category. Used on the pillar
         * AND every locality page, replacing the rotated gallery pool — one
         * deliberate photograph beats a stock shot that changes per city.
    ...
    },
    {
         ...
         */
        subServices: [
            { name: 'Laser Cut Gate Designs', desc: 'Pattern cut into the gate leaf itself — mandala, floral, geometric or your own artwork.' },
            { name: 'Sliding Gate Laser Cutting', desc: 'Panels for sliding and telescopic gates, cut to the track span.' },
            { name: 'Large Size Gate Designs', desc: 'Wide compound and industrial gates, cut in one piece up to 8000 mm.' },
            { name: 'Advanced Grill Designs', desc: 'Layered and multi-depth grill work that goes beyond a flat single pattern.' },
            { name: 'EB Grill Laser Cutting', desc: 'Ventilated grills and covers for EB meter boxes and service points.' },
            { name: 'Temple Gate Jali', desc: 'Jali screens and thoranam panels for temple entrances, in steel or brass.' },
            { name: 'Home Metal Gate Designs', desc: 'Main gates and wicket doors for residences, powder coated in any shade.' },
        ],
        /* Purpose-shot landing image for this category. Used on the pillar
         * AND every locality page, replacing the rotated gallery pool — one
         * deliberate photograph beats a stock shot that changes per city.
    ...
    },
    {
         ...
         */
        subServices: [
            { name: 'Laser Cut Safety Door Designs', desc: 'Grille and jali panels cut into the door leaf, in mild or stainless steel.' },
            { name: 'Decorative Safety Door Designs', desc: 'Pattern work that reads as decor from outside and as security from inside.' },
            { name: 'Custom Safety Door Designs', desc: 'Cut to your opening and your artwork — a single door or a full apartment block.' },
        ],
        /* Purpose-shot landing image for this category. Used on the pillar
         * AND every locality page, replacing the rotated gallery pool — one
         * deliberate photograph beats a stock shot that changes per city.
    ...
    },
    {
         ...
         */
        subServices: [
            { name: 'Interior Laser Cutting Designs', desc: 'Partitions, ceiling features and staircase screens for inside the building.' },
            { name: 'Exterior Laser Cutting Designs', desc: 'Facade, balcony and compound panels finished to stand weather.' },
            { name: 'Wall Panel Laser Cutting', desc: 'Feature wall panels, backlit or mounted on stand-offs.' },
            { name: 'Decorative Laser Cut Panels', desc: 'Screens and jali in MS, stainless or brass, cut to any pattern.' },
            { name: 'Laser Cut Wall Art', desc: 'Standalone pieces for halls, lobbies and entrances.' },
            { name: 'Floral Laser Cutting Designs', desc: 'Vine, creeper and scrollwork borders for panels and gates.' },
            { name: 'Flower Laser Cutting Designs', desc: 'Single-bloom and repeating flower motifs, cut at any scale.' },
            { name: 'Leaf Laser Cutting Designs', desc: 'Leaf and foliage patterns for screens and partitions.' },
            { name: 'Tree Laser Cutting Designs', desc: 'Tree-of-life and branch panels, a common pooja room and lobby piece.' },
            { name: 'Peacock Laser Cutting Designs', desc: 'Peacock motifs for gates, screens and temple work.' },
            { name: 'Butterfly Laser Cutting Designs', desc: "Butterfly patterns for interiors, balconies and children's spaces." },
            { name: 'Animal Laser Cutting Designs', desc: 'Elephant, bird and other figures cut from your reference.' },
        ],
        /* Purpose-shot landing image for this category. Used on the pillar
         * AND every locality page, replacing the rotated gallery pool — one
         * deliberate photograph beats a stock shot that changes per city.
