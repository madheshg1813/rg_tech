...
export function buildBlurb(seed) {
    ...
    return pick(seed.slug, 7, [
        `Laser cut ${seed.name} panels${alt} for ${listed}. Cut from mild steel, ` +
            `stainless steel, brass and copper, in sizes from a 1 ft pooja room panel ` +
    ...
    return [
        ...
        },
        {
            q: pick(slug, 53, [
                ...
                `Can you work from a temple photograph or a sketch?`,
            ]),
            a:
                `Yes, and it is most of what we do. Send a photograph, a temple image or ` +
